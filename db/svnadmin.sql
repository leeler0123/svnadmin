...
Source Host           : 5930cab67184d.gz.cdb.myqcloud.com:9226
...
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.current', '当前语言');
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.id', '键值');
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.op.addlang', '增加语言');
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.op.export', '导出多语言贡献给svnadmin项目组');
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.op.submit', '提交');
INSERT INTO `i18n` VALUES ('zh_CN', 'i18n.title', '语言管理');
INSERT INTO `i18n` VALUES ('zh_CN', 'login.btn.login', '登录');
INSERT INTO `i18n` VALUES ('zh_CN', 'login.error.usr.empty', '请输入帐号');
INSERT INTO `i18n` VALUES ('zh_CN', 'login.error.wrongpassword', '密码错误 ');
...
INSERT INTO `i18n` VALUES ('zh_CN', 'pj.save.error.existPathOrUrl', '数据库里已经存在相同的路径或url的仓库项目，请检查路径或url');
...
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.error.pj', '项目不可以为空');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.error.psw', '项目新密码不可以为空');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.error.usr', '用户不可以为空');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.info', '(注意:这里设置的用户密码只对这个项目有效)');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.op.delete', '删除');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.op.delete.confirm', '确认删除?');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.op.submit', '提交');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.psw.psw', '项目新密码');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.title', '项目用户管理');
INSERT INTO `i18n` VALUES ('zh_CN', 'pjusr.usr.select', '选择用户');
INSERT INTO `i18n` VALUES ('zh_CN', 'pj_gr.des', '描述');
INSERT INTO `i18n` VALUES ('zh_CN', 'pj_gr.gr', '组号');
...
-- Records of pj
-- ----------------------------
INSERT INTO `pj` VALUES ('leeler', '/data/svn/leeler', 'svn://139.199.8.179/leeler', 'svn', '');
...
-- Records of pj_gr
-- ----------------------------
INSERT INTO `pj_gr` VALUES ('leeler', 'developer', 'developer');
INSERT INTO `pj_gr` VALUES ('leeler', 'manager', 'manager');
INSERT INTO `pj_gr` VALUES ('leeler', 'tester', 'tester');
...
-- ----------------------------
INSERT INTO `pj_gr_auth` VALUES ('leeler', 'manager', '[leeler:/]', 'rw');
...
-- ----------------------------
INSERT INTO `pj_gr_usr` VALUES ('leeler', 'manager', 'svnadmin');
